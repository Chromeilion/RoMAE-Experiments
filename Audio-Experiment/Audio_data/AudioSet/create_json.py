...
#train_directory = "/leonardo_work/ICT25_ESP/sdigioia/Audio_data/AudioSet/balanced/train/full_bal_train/"
eval_directory = "/leonardo_work/ICT25_ESP/sdigioia/Audio_data/AudioSet/eval/full_eval/"

# Output JSON file names
#train_output_filename = "bal_train_data.json"
eval_output_filename = "eval_data.json"

#log_file_path = 'preprocess_errors.log'
log_file_path = 'preprocess_errors_eval.log'
...
print(f"JSON files created: {eval_output_filename}")
