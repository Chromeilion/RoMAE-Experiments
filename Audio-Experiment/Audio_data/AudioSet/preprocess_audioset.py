...
def preprocess_audio_files(directory):
    ...
    logging.basicConfig(filename='preprocess_errors_eval.log', level=logging.ERROR, format='%(asctime)s %(message)s')
...
directories = [
    #"/leonardo_work/ICT25_ESP/sdigioia/Audio_data/AudioSet/balanced/train/full_bal_train",
    "/leonardo_work/ICT25_ESP/sdigioia/Audio_data/AudioSet/eval/full_eval",
